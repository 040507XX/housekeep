  ...
  <div class="staff-list">
    ...
    <el-card class="action-card">
      ...
      <el-table v-loading="loading" :data="tableData" border>
        ...
        <el-table-column prop="pricePerHour" label="时薪" width="100" align="center">
          <template #default="{ row }">
            ¥{{ row.pricePerHour }}
          </template>
        </el-table-column>
    ...
    <el-dialog :title="dialogTitle" v-model="dialogVisible" width="650px" @close="resetForm">
      <el-form ref="formRef" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="时薪" prop="pricePerHour">
          <el-input-number v-model="form.pricePerHour" :min="0" :precision="2" :step="10" style="width: 100%" />
        </el-form-item>
